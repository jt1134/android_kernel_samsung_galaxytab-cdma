/* linux/drivers/mtd/onenand/samsung_galaxytab7c-me.h
 *
 * Partition Layout for Samsung CDMA GalaxyTab 7" - development device
 *
 */
 ...
 /*This is partition layout from the oneNAND it SHOULD match the pitfile on the second page of the NAND.
   ...
   #########################################################################################*/ 
	...
	},
	{
		.name		= "cache",
		.offset		= (1132*SZ_256K),
		.size		= (120*SZ_256K), //1251
	},
	{
		.name		= "userdata",
		.offset		= (1252*SZ_256K),
		.size		= (752*SZ_256K), //2003
	},
